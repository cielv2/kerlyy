...
const nyoutube = ('© Bot By AnggaXyzz')  //ubah di config biar ngk emror
...
break
		...
		let { webp2mp4File } = require('./lib/uploader')
            ...
            let { toAudio } = require('./lib/converter')
            let audio = await toAudio(media, 'mp4')
            naze.sendMessage(m.chat, {document: audio, mimetype: 'audio/mpeg', fileName: `Convert By ${angga.user.name}.mp3`}, { quoted : m })
            }
            break
